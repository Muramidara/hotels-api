...
-- Reset the Hotel ID sequence to start from 16 (since you used IDs 1-15)
ALTER TABLE hotel ALTER COLUMN id RESTART WITH 16;
ALTER TABLE address ALTER COLUMN id RESTART WITH 16;
ALTER TABLE contacts ALTER COLUMN id RESTART WITH 16;
ALTER TABLE arrival_time ALTER COLUMN id RESTART WITH 16;
ALTER TABLE amenity ALTER COLUMN id RESTART WITH 13;
ALTER TABLE hotel_amenity ALTER COLUMN id RESTART WITH 61;