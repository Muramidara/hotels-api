...
public interface HotelRepository extends JpaRepository<Hotel, Long> {
    ...
    @Query(value = "SELECT h FROM Hotel h JOIN FETCH Address a WHERE a.city = :city")
    List<Hotel> findAllByCity(@Param("city") String city);
    @Query(value = "SELECT h FROM Hotel h JOIN FETCH Address a WHERE a.country = :country")
