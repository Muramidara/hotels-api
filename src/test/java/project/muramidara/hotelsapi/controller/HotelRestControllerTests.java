package project.muramidara.hotelsapi.controller;
...
@WebMvcTest
public class HotelRestControllerTests {
    ...
    public void givenHotelDto_whenCreate_thenSuccessResponse() throws Exception {
        ...
        BDDMockito.given(hotelService.create(any(HotelCreateEditDto.class))).willReturn(readDto);
        //when
