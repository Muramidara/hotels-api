...
-- ============================================================
-- Reset sequences for PostgreSQL (H2: ALTER TABLE ... ALTER COLUMN ... RESTART WITH)
-- ============================================================
ALTER SEQUENCE address_id_seq RESTART WITH 16;
ALTER SEQUENCE contacts_id_seq RESTART WITH 16;
ALTER SEQUENCE arrival_time_id_seq RESTART WITH 16;
ALTER SEQUENCE hotel_id_seq RESTART WITH 16;
ALTER SEQUENCE amenity_id_seq RESTART WITH 13;
ALTER SEQUENCE hotel_amenity_id_seq RESTART WITH 61;